...
- **FR-020**: The extraction MUST NOT change public APIs, contract semantics, schema semantics, authentication, authorization, invocation routing, cancellation, failure mapping, or Ledger lineage.
