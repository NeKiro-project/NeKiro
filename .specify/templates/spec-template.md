...
<!--
  ACTION REQUIRED: The content in this section represents placeholders.
  Only include assumptions supported by existing contracts, ADRs, runbooks, or
  user decisions. Mark unsupported policy choices as NEEDS CLARIFICATION; do
  not invent fallback behavior or security-sensitive defaults.
-->
