...
**Tests**: Tests are required and are scheduled after the corresponding approved implementation. Each test task must reference a Spec acceptance scenario, failure semantic, or compatibility requirement.
...
- [ ] T020 [US2] Implement [endpoint/feature] in src/[location]/[file].py
...
- Core implementation before mapped contract, integration, and E2E tests
...
```bash
# After implementation, launch all mapped tests for User Story 1 together:
