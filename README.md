...
the Core documentation and read-only snapshots of the Console, SDK, Samples,
Stack, and A2A transport documentation in English and Chinese. Satellite
source and canonical ownership remain in their respective repositories.
